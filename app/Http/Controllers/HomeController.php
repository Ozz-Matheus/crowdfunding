...
class HomeController extends Controller
{
    ...
    public function index(){
        ...
        $staff_picks = Campaign::active()->staff_picks()->with('user', 'success_payments', 'feature_media')->orderBy('id', 'desc')->take(8)->get();
        $new_campaigns = Campaign::active()->with('user', 'success_payments', 'feature_media')->orderBy('created_at', 'desc')->take(20)->get();
        $funded_campaigns = Campaign::active()->funded()->with('user', 'success_payments', 'feature_media')->orderBy('id', 'desc')->take(8)->get();
