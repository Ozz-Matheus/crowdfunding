...
if ( ! function_exists('media_image_uri')){
    function media_image_uri($media = 0){
        ...
        if ($media_id){
            ...
            if ($media){
                ...
                if ($source == 'public'){
                    ...
                    $url_path = \Illuminate\Support\Facades\Storage::disk('s3')->url("uploads/".$media->slug_ext);
                }
            }
        }
...
if ( ! function_exists('image_upload_form')){
    function image_upload_form($input_name = 'image_id', $current_image_id = '', $only_image = true){
        if ( ! $input_name){
            $input_name = 'image_id';
        }
        ?>
