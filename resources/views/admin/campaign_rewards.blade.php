                ...
                <div id="page-wrapper">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-1 col-xs-12">
                            ...
                            <div class="form-group row {!! $errors->has('digital_downloads')? 'has-error':'' !!}">
                                <label for="digital_downloads" class="col-sm-4 control-label">@lang('app.digital_downloads')</label>
                                <div class="col-sm-8">
                                    {!! image_upload_form('digital_downloads', '', false) !!}
                                    {!! $errors->has('digital_downloads')? '<p class="help-block">'.$errors->first('digital_downloads').'</p>':'' !!}
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($reward->digital_downloads)
                                                        ...
                                                        @if($reward_media)
                                                            <a href="{{asset('uploads/'.$reward_media->slug_ext)}}">{!! $reward_media->name !!}</a>
                                                        @endif
                                                    @endif
